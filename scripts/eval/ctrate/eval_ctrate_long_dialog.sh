...
CUDA_VISIBLE_DEVICES=1 python scripts/eval/ctrate/eval_ctrate_text.py \
    --answer_path /hdd/shiym/datasets_processed/MedM-VL/ctrate/valid_long_dialog.json \
    --predict_path $MODEL_PATH/eval/valid_long_dialog.json \
    --result_path $MODEL_PATH/eval/valid_long_dialog_result.json
