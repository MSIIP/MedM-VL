...
CUDA_VISIBLE_DEVICES=0 python lvlm/inference.py \
    --model_dtype float16 \
    --data_path /hdd/shiym/datasets_processed/MedM/gqa/gqa.json \
    --conv_version phi \
...
python scripts/eval/gqa/eval_gqa.py \
    --question_path /hdd/shiym/datasets_processed/MedM/gqa/gqa.json \
