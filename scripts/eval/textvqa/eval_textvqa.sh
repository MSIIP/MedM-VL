...
CUDA_VISIBLE_DEVICES=7 python lvlm/inference.py \
    --model_dtype float16 \
    --data_path /hdd/shiym/datasets_processed/MedM/textvqa/textvqa.json \
    --conv_version phi \
...
python scripts/eval/textvqa/eval_textvqa.py \
    --question_path /hdd/shiym/datasets_processed/MedM/textvqa/textvqa.json \
