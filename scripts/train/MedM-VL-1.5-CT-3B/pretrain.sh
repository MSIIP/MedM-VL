...
deepspeed --include localhost:0,1 --master_port 29501 lvlm/train.py \
    ...
    --data_path /hdd/shiym/datasets_processed/MedM-VL/radiopaedia/ct_train_caption_duplicate.json \
    ...
    --output_dir /hdd/shiym/work_dirs/MedM-VL/MedM-VL-1.5-CT-3B-pretrain \
